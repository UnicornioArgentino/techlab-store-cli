...
NPM SCRIPTS (atajos)
  npm run get:all        # GET products
  npm run get:one        # GET products/5
  npm run post:demo      # POST demo product
  npm run del:demo       # DELETE products/7

CATEGORÍAS
  npm run get:cat:list   # GET products/category/list
  npm run get:cat:elec   # GET products/category/electronics

EXPORT A CSV
  npm run export:all     # EXPORT products -> ./output/products_YYYYMMDD-HHMM.csv
...
NOTAS
  ...
  • Los CSV se guardan en ./output/.
  • Si ves advertencias de CRLF en Windows, son seguras.
`;
